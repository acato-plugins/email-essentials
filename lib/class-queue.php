...
class Queue {
  ...
  KEY `ip` (`ip`(255))
	...
	/**
	 * Get the time window to count the number of sent emails in. A larger window makes a stricter system.
	 *
	 * @return mixed|null
	 */
	...
	/**
	 * Get the max amount of emails allowed to be sent within the time window (from the same IP). A smaller amount makes a stricter system.
	 *
	 * @return int
	 */
	...
	/**
	 * Get the amount of emails sent in a single batch.
	 *
	 * @return int
	 */
	...
	public static function admin_menu() {
		// Set an indicator in the menu for the amount of emails in the queue.
